...
import MainPackage.Register2Frame;
...
public class Accounts extends javax.swing.JInternalFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT user_id, user_fname, user_lname, user_email, user_uname, user_pass FROM tbl_user");
            user_tbl.setModel(DbUtils.resultSetToTableModel(rs));
            DefaultTableModel model = (DefaultTableModel) user_tbl.getModel();
            String[] columnIdentifiers = {"User ID", "First Name", "Last Name", "Email", "Username", "Password"};
    ...
    private void add_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add_btnMouseClicked
        ...
        mainFrame.dispose();
        Register2Frame reg = new Register2Frame();
        reg.setVisible(true);
        
        reg.action = "Add";
        reg.action_lbl.setText("SAVE");
    ...
    private void edit_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_btnMouseClicked
        ...
        if(rowIndex < 0){
            ...
            Register2Frame reg = new Register2Frame();
            reg.userid_inp.setText(""+model.getValueAt(rowIndex, 0));
            String uid = model.getValueAt(rowIndex, 0).toString();
            try{
            DBconnector dbc = new DBconnector();
            ResultSet rs = dbc.getData("SELECT * FROM tbl_user WHERE user_id = '"+uid+"' ");
            if(rs.next()){
            reg.userfname_inp.setText(rs.getString("user_fname"));
            reg.userlname_inp.setText(rs.getString("user_lname"));
            reg.useremail_inp.setText(rs.getString("user_email"));
            reg.useruname_inp.setText(rs.getString("user_uname"));
            reg.userpass_inp.setText(rs.getString("user_pass"));
            
            reg.setVisible(true);
            reg.action = "Update";
            reg.action_lbl.setText("UPDATE");
            JFrame mainFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
            mainFrame.dispose();
            }else{
    ...
    private void delete_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delete_btnMouseClicked
        ...
        if(rowIndex < 0){
            ...
            if(a == JOptionPane.YES_OPTION){
                ...
                dbc.deleteData(user_id, "tbl_user", "user_id");
                displayData();
            }
        }
    ...
    private void print_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_print_btnMouseClicked
        ...
        try{
            user_tbl.print(JTable.PrintMode.FIT_WIDTH, header, footer);          
