...
import MainPackage.ProductFrame;
...
public class Product extends javax.swing.JInternalFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT product_id, name, description, price, quantity FROM tbl_product");
            prod_tbl.setModel(DbUtils.resultSetToTableModel(rs));
            DefaultTableModel model = (DefaultTableModel) prod_tbl.getModel();
            String[] columnIdentifiers = {"ID", "Name", "Description", "Price", "Quantity"};
    ...
    private void initComponents() {
        ...
        prod_tbl = new javax.swing.JTable();
        ...
        jScrollPane1.setViewportView(prod_tbl);
    ...
    Image newImg = img.getScaledInstance(prod.prodimg_display.getWidth(), prod.prodimg_display.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void edit_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_btnMouseClicked
        int rowIndex = prod_tbl.getSelectedRow();
        if(rowIndex < 0){
            JOptionPane.showMessageDialog(null, "Please Select an Item!");
        }else{
            TableModel model = prod_tbl.getModel();
            
            ProductFrame prod = new ProductFrame();
            prod.prodid_inp.setText(""+model.getValueAt(rowIndex, 0));
            String pid = model.getValueAt(rowIndex, 0).toString();
            try{
            DBconnector dbc = new DBconnector();
            ResultSet rs = dbc.getData("SELECT * FROM tbl_product WHERE product_id = '"+pid+"' ");
            if(rs.next()){
            prod.prodname_inp.setText(rs.getString("name"));
            prod.prodscript_inp.setText(rs.getString("description"));
            prod.prodprice_inp.setText(rs.getString("price"));
            prod.prodquantity_inp.setText(rs.getString("quantity"));
            prod.prodimg_display.setIcon(ResizeImage(null, rs.getBytes("product_image")));
            
            prod.setVisible(true);
            prod.action = "Update";
            prod.action_lbl.setText("UPDATE");
            JFrame mainFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
            mainFrame.dispose();
            }else{
    ...
    private void delete_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delete_btnMouseClicked
        ...
        if(rowIndex < 0){
            ...
            if(a == JOptionPane.YES_OPTION){
                ...
                dbc.deleteData(product_id, "tbl_product", "product_id");
                displayData();
            }
        }
    ...
    private void print_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_print_btnMouseClicked
        ...
        MessageFormat footer = new MessageFormat("Database Management System Output");
        try{
            prod_tbl.print(JTable.PrintMode.FIT_WIDTH, header, footer);          
    ...
    private javax.swing.JTable prod_tbl;
